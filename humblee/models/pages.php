...
class Core_Model_Pages {
     ...
     */
    public function getPagefromURL($uri_parts,$recursionFlag=false)
    {
        ...
        { // if no page was found, maybe the end of the url is really a variable being passed to the controller.  lop it off and try again.
			...
			return $this->getPagefromURL($uri_parts,true); // recursivly re-run this function (and set $recursionFlag to TRUE)
		}
        else
        {
			if($recursionFlag)
